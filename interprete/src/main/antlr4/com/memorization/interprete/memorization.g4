    ...
    |   typesProtection
        {
        	if (labelMemorizationDetected == true){
        		nombreMetodo = nombreMetodo +  $typesProtection.text + " ";
 ...
 */
methodDeclaration
    :   methodTypeOfReturn Identifier formalParameters ('[' ']')*
        methodThrows?
        (   methodBody
        |   ';'
        )
        {
        	if (startDetectionMethod == true){
        		...
        		System.out.println ("startDetectionMethod = " + startDetectionMethod);
        		System.out.println ("finishDetection = " + finishDetection);
        		tipoDeRetorno = $methodTypeOfReturn.text;
        		identificadorMetodo = $Identifier.text;   		
        		
        		if ($methodThrows.text == null)
        			nombreMetodo = nombreMetodo + $methodTypeOfReturn.text + " "  + $Identifier.text + " " + "( " +  reader.crearCabeceraArgumentos(Argumentos) + ") {" ;
        		else
        			nombreMetodo = nombreMetodo + $methodTypeOfReturn.text + " "  + $Identifier.text + " " + "( " +  reader.crearCabeceraArgumentos(Argumentos) + ") " + $methodThrows.text;
...
formalParameter
    :   variableModifier* typeType variableDeclaratorId {
    	if (primitiveType == true) {
    		primitiveType = false;
    		if (startDetectionMethod == true) Argumentos.add("" + $typeType.text + " "+ $variableDeclaratorId.text);
    	}
    }
    ;
